...
urlpatterns = [
    ...
    # Checker's specific 'admin-only' route
    path('admin-only/', views.admin_view, name='admin_only_view'), # Added for checker
    ...
    path('user/<str:username>/assigned-books/', views.user_assigned_books_view, name='user_assigned_books_view'),
]
