...
# Add this for serving media files during development (ONLY in DEBUG mode)
if settings.DEBUG:
    urlpatterns += static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT) # <--- ADDED THIS BLOCK
