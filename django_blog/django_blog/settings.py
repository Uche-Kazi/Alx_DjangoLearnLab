...
SECRET_KEY = 'django-insecure-w_@x3%t#^6s_s8z#y^2e7b-w^7k=)d)i*&13+e&m3d(s1n5_#)'
...
INSTALLED_APPS = [
    ...
    'blog',
    'taggit',  # We need to add 'taggit' to the installed apps.
...
# Set up media root and URL for uploaded files
MEDIA_URL = 'media/'
